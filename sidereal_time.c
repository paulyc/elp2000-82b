 ...
 *
 * jd = ut1, jde = tt
 * TT runs a little ahead of UT1 (a refined measure of mean solar time at Greenwich) by an
 * amount known as ΔT = TT − UT1. ΔT was measured at +67.6439 seconds (TT ahead of UT1) at
 * 0h UTC on 1 January 2015;[9] and by retrospective calculation, ΔT was close to zero around
 * the year 1900. The difference ΔT, though somewhat unpredictable in fine detail, is expected
 * to continue to increase, with UT1 becoming steadily (but irregularly) further behind TT in
 * the future.
 */
